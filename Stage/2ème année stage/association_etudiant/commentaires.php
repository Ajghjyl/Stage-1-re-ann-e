 ...
 session_start();
           ...
           include("includes/navigateur.php");
...
<div class="menu">
                          <ul>
                                <li> <a href="membres/profil.php">Mon compte</a> </li> 

                                <li> <a href="membres/deconnexion.php">Se déconnecter</a> </li>
